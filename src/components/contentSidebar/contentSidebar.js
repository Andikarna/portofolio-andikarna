    ...
    <>
      <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-900">
        ...
        <ul class="block lg:hidden pt-5 space-y-2 font-medium">
          <li>
            <Link href="/" className={`flex items-center  h-10 px-2 py-1 rounded-lg text-dark dark:text-gray-300 hover:bg-gray-100 dark:hover:text-teal-300 dark:hover:bg-gray-800 ${route == '/' ? ('bg-gray-200 dark:bg-gray-800 dark:text-teal-300') : ('')}`}>
              <BiHomeSmile className="text-xl mr-2" />
              {locale == 'id-ID' ? ('Beranda') : (' Home')}</Link>
          </li>
          <li>
            <Link href="/menu/about" className={`flex items-center h-10 px-2 py-1 rounded-lg text-dark dark:text-gray-300 hover:bg-gray-100 dark:hover:text-teal-300 dark:hover:bg-gray-800 ${route == '/menu/about' ? ('bg-gray-200 dark:bg-gray-800 dark:text-teal-300') : ('')}`}>
              <MdOutlineAllInclusive className="text-xl mr-2" />
              {locale == 'id-ID' ? ('Tentang Saya') : ('About')}</Link>
          </li>
          <li>
            <Link href="/menu/product" className={`flex items-center h-10 px-2 py-1 rounded-lg text-dark dark:text-gray-300 hover:bg-gray-100 dark:hover:text-teal-300 dark:hover:bg-gray-800 ${route == '/menu/product' ? ('bg-gray-200 dark:bg-gray-800 dark:text-teal-300') : ('')}`}>
